...
- Name: homepage.spec.ts >> Search >> has search input
- Location: tests/e2e/homepage.spec.ts:58:3
...
Locator: locator('input[type="search"], input[placeholder*="earch"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input[type="search"], input[placeholder*="earch"]').first()
