...
- Name: homepage.spec.ts >> Blog Index >> displays article cards
- Location: tests/e2e/homepage.spec.ts:32:3
...
Locator: locator('article, [class*="card"]').first()
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('article, [class*="card"]').first()
